...
<script src="http://maps.google.it/maps/api/js?key=AIzaSyCvyZ6DB32hcO3vkSpNR4JpAwh6hiRQqVc&libraries=places"  type="text/javascript"></script>
...
<body>
        ...
        <ul class="navbar-nav mt-2 mt-lg-0" >
          ...
          <li class="nav-item">
            ...
            if(isset($_SESSION["logIn"])&&$_SESSION["logIn"]==true){
              ...
              echo "<div class='row' style='margin:0;'><div class='col-8 usernav' style='padding:0'><a class='nav-link ' href='Carrello.php'><i class='fas fa-user'></i>   ".$_SESSION["user"]."</a></div>";
  ...
  <div class="container-fluid underNav">
    ...
    <div class="FormOrdine" >
      <form id="FormConsegna"  method="POST" >
    ...
    <script>
    function init(){
      var input = document.getElementById("ConsegnaAddress");
      var autocomplete = new google.maps.places.Autocomplete(input);
    }
    google.maps.event.addDomListener(window, 'load', init);
    </script>
    <div class="FormOrdine" >
      <form  id="FormRitiro" method="POST" >
