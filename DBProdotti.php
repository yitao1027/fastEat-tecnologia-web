        ...
        <ul class="navbar-nav mt-2 mt-lg-0 ">
          ...
          <li class="nav-item">
            ...
            if(isset($_SESSION["logIn"])&&$_SESSION["logIn"]==true){
              ...
              echo "<div class='row' style='margin:0;'><div class='col-8 usernav' style='padding:0'><a class='nav-link ' href='Administratore.php'><i class='fas fa-user'></i>   ".$_SESSION["user"]."</a></div>";
      ...
      <form  id="FormProdotto" method="POST" >
        <div class="form-row">
          <div class="form-group col-md-4">
            <label for="piattoId">ID</label>
            <input  id="piattoId" name="piattoId" type="number" class="form-control" required>
          </div>
          <div class="form-group col-md-4">
            <label for="PiattoName">Piatto Nome</label>
            <input  id="PiattoName" name="piattoName" type="text" class="form-control"  required>
          </div>
          <div class="form-group col-md-4">
