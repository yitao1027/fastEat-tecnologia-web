...
<input type="text" value="" placeholder="Inserisci il tuo indirizzo"  style="line-height: 40px; border-radius:10px;">
<button type="button"><i class="fas fa-location-arrow" style="color:rgb(48, 221, 48);"></i></button>
</div>
        </div>
    ...
    <div class="container-fluid text-center">
      <div class="row">
        ...
        <div class="contact col-sm-3">
          ...
          <a href="https://goo.gl/maps/FKWqDztU5rL2" target="_blank">Viale Trento, 34
            <br>47042 cesenatico(FC)</a>
          </div>
          <div class="contact col-sm-3">
            <i class="fa fa-envelope fa-2x"></i><br>
            <a href="mailto:FastEat@gmail.com">okinawaCesenatico.it</a>
          </div>
