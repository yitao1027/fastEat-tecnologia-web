...
<body>
    ...
    <div id="navbar">
        <ul class=" navbar-list text-uppercase nav navbar-right" data-spy="affix" data-offset-top="205">
            ...
            <li>
                <a href="#carello.html">
                    <i class="fa fa-shopping-cart fa-2x  list-item" aria-hidden="true"></i>Carello</a>
            </li>
            <li>
    ...
    <div id="registerForm" class="modal fade" role="dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="FastEatRegister.php" method="POST">
                        ...
                        <div id="messagePsw" > <p id="passLength" class="invalid">password length min 8 char</p></div>
                        <!-- form-control : width 100% backgrounf borderadius etc-->
                        <input class="form-control" type="password" id="psw"  placeholder="Enter Password" name="psw"required>
                        <label>
                                <b>Confirm Password</b>
                        </label>
                        <div id="messageConfpsw" > <p  id="confpassLength" class="invalid">password length min 8 charset</p></div>
        ...
        var confpass_field = document.getElementById("confpsw");
// When the user clicks on the password field, show the message box
password_field.onfocus= function(){
            document.getElementById("messagePsw").style.display = "block";
        }; 
confpass_field.onfocus=function(){
            document.getElementById ("messageConfpsw").style.display = "block";
        };

        password_field.onblur= function(){
            document.getElementById("messagePsw").style.display = "none";
        }; 
confpass_field.onblur=function(){
            document.getElementById ("messageConfpsw").style.display = "none";
        };
// When the user starts to type something inside the password field
  password_field.onkeyup = ValidateLength(password_field);
  confpass_field.onkeyup=ValidateLength(confpass_field);
</script>
