          ...
          <ul class="navbar-nav mt-2 mt-lg-0 ">
            ...
            <li class="nav-item">
              ...
              if(isset($_SESSION["logIn"])&&$_SESSION["logIn"]==true){
                ...
                echo "<div class='row' style='margin:0;'><div class='col-8 usernav' style='padding:0'><a class='log nav-link' href='Carrello.php'><i class='fas fa-user'></i>   ".$_SESSION["user"]."</a></div>";
